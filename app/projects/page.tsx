          ...
          <div className="max-w-6xl mx-auto">
            <div className="space-y-16 sm:space-y-20 md:space-y-24">
              {projects.map((project, index) => (
                <div key={project.id} className={`flex flex-col ${index % 2 === 1 ? 'md:flex-row-reverse' : 'md:flex-row'} gap-8 sm:gap-12 md:gap-16 lg:gap-20 items-center`}>
                  ...
                  <ScrollAnimation delay={index === 0 ? 0.2 : 0.4}>
                    <div className="w-full space-y-4 sm:space-y-6">
                      <div className="mb-4 sm:mb-6">
                        ...
                        <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-700 font-bold mb-4 sm:mb-6">{project.description}</p>
