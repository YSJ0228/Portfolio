...
const projects: Project[] = [
  {
    ...
    longDescription:
      "체험단 참여자와 브랜드를 연결하는 매칭 플랫폼입니다. 체험단 참여자는 다양한 체험 기회를 쉽게 찾고 신청할 수 있으며, 체험 후 리뷰 작성으로 활동을 관리할 수 있습니다. 브랜드는 체험단을 효율적으로 모집하고 체계적으로 관리할 수 있습니다. 체험단 모집·신청, 리뷰 작성·관리, 지역·카테고리 기반 검색, 예약 시스템 등 편리한 기능을 제공합니다.",
    technologies: [
      "Next.js",
      "React",
      "TypeScript",
    ...
    demo: "https://reviewpop.vercel.app/",
    featured: true,
  },
  {
    id: 1,
    ...
    longDescription:
      "이사 고객과 이사 기사님을 연결해주는 매칭 플랫폼입니다. 고객은 원하는 이사 업체의 견적을 쉽게 비교하고 선택할 수 있으며, 기사님은 효율적으로 일을 받을 수 있습니다. 견적 비교, 견적 관리, 지역 기반 검색, 리뷰 시스템 등 편리한 기능을 제공합니다.",
    technologies: [
      "TypeScript",
      "React",
      "Next.js",
  ...
  },
  {
    ...
    longDescription:
      "포토카드를 생성, 판매, 교환할 수 있는 디지털 포토카드 거래 플랫폼입니다. 사용자는 마켓에서 카드를 검색하고 구매할 수 있으며, 자신의 카드 자산을 기반으로 다른 유저와 교환을 제안하고 승인할 수 있습니다. 랜덤 상자 뽑기로 포인트를 얻고, 한 달에 카드 3장 생성 제한과 카드별 최대 10장 발행 할 수 있습니다.",
    technologies: [
      "Next.js",
      "Tailwind CSS",
      "React Query",
  ...
  },
  {
    ...
    longDescription:
      "스타트업 투자 경험을 위한 모의 투자 서비스입니다. 다양한 스타트업의 정보를 조회하고 최대 5개 기업을 선택해 누적 투자 금액, 매출액, 고용 인원 등을 비교할 수 있습니다. 가상 투자를 통해 투자 경험을 쌓고, 투자 현황을 조회하여 트렌드를 파악할 수 있습니다.",
    technologies: [
      "React",
      "SCSS",
      "CSS Modules",
...
export default function Projects() {
  ...
  return (
    <main className="min-h-screen pt-16">
      {/* Hero Section */}
      <section className="pt-20 sm:pt-28 md:pt-40 pb-12 sm:pb-16 md:pb-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 via-white to-gray-50">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="space-y-16 sm:space-y-20 md:space-y-24">
              {projects.map((project, index) => (
                <div
                  key={project.id}
                  className={`flex flex-col ${index % 2 === 1 ? "md:flex-row-reverse" : "md:flex-row"} gap-8 sm:gap-12 md:gap-16 lg:gap-20 items-center`}
                >
                  <ScrollAnimation delay={index === 0 ? 0 : 0.2}>
                    <div className="w-full flex justify-center">
                      <div className="w-[250px] sm:w-[280px] md:w-[300px] h-[580px] sm:h-[650px] md:h-[700px] flex items-center justify-center">
                        <Image
                          src={project.image}
                          alt={project.title}
                          width={600}
                  ...
                  <ScrollAnimation delay={index === 0 ? 0.2 : 0.4}>
                    <div className="w-full space-y-4 sm:space-y-6">
                      <div className="mb-4 sm:mb-6">
                        <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black mb-2 sm:mb-3 bg-gradient-to-r from-gray-900 via-gray-800 to-black bg-clip-text text-transparent">
                          {project.title}
                        </h3>
                        <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-700 font-bold mb-4 sm:mb-6">
                          {project.description}
                        </p>
                        <div className="h-1 w-16 sm:w-20 bg-gradient-to-r from-gray-900 to-transparent rounded-full"></div>
                      </div>
                      ...
                      <div>
                        <h4 className="text-base font-bold text-gray-500 uppercase tracking-wider mb-4">
                          기술 스택
                        </h4>
